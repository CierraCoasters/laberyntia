...
let lista_preguntas = {
	...
	personalizadas: [
		{pregunta: "¿Cuál de las siguientes atracciones desapareció antes de Terra Mítica? [@CierraCoasters]", respuesta1: "Los Secretos de los Dioses", respuesta2: "El Misterio de Keops", respuesta3: "El Rescate de Ulises", correcta: 1},
		{pregunta: "¿Cómo se llamaba la actual Titánide cuando estaba en la zona de Iberia? [@CierraCoasters]", respuesta1: "Titánide (igual)", respuesta2: "Tizona", respuesta3: "Colada", correcta: 2},
		{pregunta: "¿Bajo qué monumento egipcio se accede a Terra Mítica? [@CierraCoasters]", respuesta1: "La Pirámide de Keops", respuesta2: "El Faro de Alejandría", respuesta3: "La Puerta de Karnak", correcta: 3},
		{pregunta: "¿En qué zona de Terra Mítica se encuentra el área de piscinas? [@CierraCoasters]", respuesta1: "Roma", respuesta2: "Iberia", respuesta3: "Las Islas", correcta: 2},
		{pregunta: "¿Cómo se llama el espectáculo más longevo del parque? [@CierraCoasters]", respuesta1: "Barbarroja", respuesta2: "Arde Troya", respuesta3: "El Torneo", correcta: 3},
		{pregunta: "¿En las colas de qué antigua atracción se desarrolla Arde Troya? [@CierraCoasters]", respuesta1: "El Rescate de Ulises", respuesta2: "Magnus Colossus", respuesta3: "Los Secretos de los Dioses", correcta: 1},
		{pregunta: "¿Cuál de las siguientes fue una dark ride planeada, pero nunca construida, de Terra Mítica? [@perdidos_en_la_odisea]", respuesta1: "La Aventura del Cid", respuesta2: "La locura de Nerón", respuesta3: "La Máquina del Tiempo", correcta: 3},
		{pregunta: "¿Cómo se llamaba la moneda oficial de Iberia Park? [@perdidos_en_la_odisea]", respuesta1: "Íbero", respuesta2: "Real", respuesta3: "Peseta", correcta: 1},
		{pregunta: "¿Cuáles de estos nombres corresponden a dos de las barcas que recorren el lago de Terra Mítica? [@perdidos_en_la_odisea]", respuesta1: "Anubis y Duat", respuesta2: "Seker y Henu", respuesta3: "Horus y Seth", correcta: 2}, // Hay otras 4: Eneida, Ilíada, Gregal y Xaloc
		{pregunta: "¿Cómo se llamaba el restaurante que se encontraba donde hoy está La Cólera de Akiles? [@perdidos_en_la_odisea]", respuesta1: "Corfú", respuesta2: "Acrópolis", respuesta3: "Rodas", correcta: 1},
		{pregunta: "¿Cómo se llama la ranita mascota de Terra Mítica? [@perdidos_en_la_odisea]", respuesta1: "Cuca", respuesta2: "Gustavo", respuesta3: "Paula", correcta: 1},
		{pregunta: "¿Cómo se llama el hipopótamo mascota de Terra Mítica? [@perdidos_en_la_odisea]", respuesta1: "Terri", respuesta2: "Mitic", respuesta3: "Pepe", correcta: 2},
		{pregunta: "¿Cómo se llama el camello mascota de Terra Mítica? [@perdidos_en_la_odisea]", respuesta1: "Sandy", respuesta2: "Alí", respuesta3: "Babá", correcta: 3},
		{pregunta: "¿Cómo se llamaba el pirata mascota de Iberia Park? [@CierraCoasters]", respuesta1: "Barbarroja", respuesta2: "Jack", respuesta3: "Capitán Kidd", correcta: 3},
		{pregunta: "¿Cómo se llamaba el toro mascota de Iberia Park? [@CierraCoasters]", respuesta1: "Fernando", respuesta2: "Rudi", respuesta3: "Manolo", correcta: 2},
		{pregunta: "¿Cómo se llamaba la Medusa mascota de Iberia Park? [@CierraCoasters]", respuesta1: "Petri", respuesta2: "Melisa", respuesta3: "Medusa", correcta: 3},
		{pregunta: "¿En qué año se trasladó Tizona de Iberia a Grecia? [@fansterramitica]", respuesta1: "2009", respuesta2: "2003", respuesta3: "2013", correcta: 1},
		//{pregunta: " [@]", respuesta1: "", respuesta2: "", respuesta3: "", correcta: 0},
	],
};
